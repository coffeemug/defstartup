...
* __The LRU prioritization method__ -- since you can only work on one
  ...
  important problem at any given time, work on that, and ignore
  everything else. This method also works with organizing most things
  (from email to physical possessions).
