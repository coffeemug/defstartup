...
* __Inversion__ (aka [failure mode]) -- the observation that many hard
  problems are best solved when they're addressed backward. In other
  words figure out what you don’t want, avoid it, and you’ll get what
  you do want.<br>
...
* [Structure and agency] -- the observation that human behavior
  ...
  __Corollary:__ Present a structure in front of even the most
...
* __Controlled volnurability:__ -- the observation that humans are
  ...
  volnurability expression followed by relief and a strong bond.
