...
* __The small-improvmenets method__ -- the observation that in many
  domains frequently making small incremental improvements is a better
  approach than attempting to fix big looming problems once.
